<article class="prose mx-auto">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Website</strong> refers to eAuction, accessible from
				<a href="https://redis-eAuction.com" rel="external nofollow noopener" target="_blank"
					>https://redis-eAuction.com</a
				>
			</p>
		</li>
		<li>
	...
	<ul>
		<li>
			By visiting this page on our website: <a
				href="https://redis-eAuction.com"
				rel="external nofollow noopener"
				target="_blank">https://redis-eAuction.com</a
			>
		</li>
	</ul>
</article>
